    ...
    <StoreShell current="contact">
      <main className="contact-page">
        ...
        <section className="contact-layout">
          <div className="contact-details"><article><Mail size={19} /><div><span>Email</span><a href="mailto:hello@mkstudio.example">mksolutionscebu.@gmail.com</a></div></article><article><Phone size={19} /><div><span>Phone</span><a href="tel:+0000000000">+09951813723</a></div></article><article><MapPin size={19} /><div><span>Studio visits</span><p>By appointment only<br />Location details on confirmation</p></div></article><article><Instagram size={19} /><div><span>Social</span><a href="#" onClick={e => e.preventDefault()}>@mkstudio</a></div></article></div>
