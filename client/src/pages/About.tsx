    ...
    <StoreShell current="about">
      <main className="about-page">
        ...
        <section className="about-story">
          <div className="about-story-image"><img src="/images/my-studio-original-wardrobe_46a8eeb0.png" alt="MK Studio’s wardrobe in jewel tones" loading="lazy" decoding="async" /></div>
