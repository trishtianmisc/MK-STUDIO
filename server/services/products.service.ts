...
const SELECT_ADMIN_LIST = "id, category_id, name, slug, style, length, brand, rental_price, additional_day_price, availability, closet, is_featured, image, sort_order, is_public, created_at, updated_at, categories(id, slug, name)" as const;
